                      ...
                      <div class="mt-4">
                        ...
                        <form method="POST" action="" enctype="multipart/form-data">
                          ...
                          <label class="block mt-4 text-sm w-1/2" id="image-item-<?= $student['student_id'] ?>">
                            ...
                            <input id="image-place-<?= $student['student_id'] ?>"
                              data-id="<?= $student['student_id'] ?>" type="file" name="photo"
                              class="form-control hidden">
                            <img class="mt-1 mb-2" style="height: 75px; width: 50%; object-fit: cover;"
                              id="image-preview-<?= $student['student_id'] ?>" src="<?= $student['photo'] ?>">
