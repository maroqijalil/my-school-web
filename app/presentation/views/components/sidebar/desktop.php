  ...
  <div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <ul>
      <li class="relative px-6 py-3">
        ...
        <?php } ?>
        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="/daftar-guru">
      ...
      <li class="relative px-6 py-3">
        <?php if ($page == "wali") { ?>
          <span class="absolute inset-y-0 left-0 w-2 bg-sp-primary-100 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
        <?php } ?>
        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="/daftar-ortu">
      ...
      <li class="relative px-6 py-3">
        <?php if ($page == "pembayaran") { ?>
          <span class="absolute inset-y-0 left-0 w-2 bg-sp-primary-100 rounded-tr-lg rounded-br-lg" aria-hidden="true"></span>
        <?php } ?>
        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200" href="/daftar-pembayaran">
